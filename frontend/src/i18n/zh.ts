...
export default {
  ...
  "providers.title": "提供商",
  "providers.subtitle": "管理官方 Codex 与第三方 API 提供商",
  "providers.add": "添加提供商",
  ...
  "providers.officialName": "Codex 官方",
  "providers.officialDirect": "官方直连 · 保留 ChatGPT 登录",
  "providers.officialAccountReady": "官方账号已就绪",
  "providers.officialNotLoggedIn": "尚未登录官方账号",
  "providers.officialLogin": "官方登录",
  "providers.officialCancelLogin": "取消登录",
  "providers.officialLoginFailed": "官方登录失败",
  "providers.officialSwitchSuccess": "已切换到 Codex 官方",
  "providers.officialSwitchFailed": "切换 Codex 官方失败",
  "providers.providerSwitchSuccess": "已切换到第三方提供商",
  "providers.added": "已添加",
  ...
  "providers.empty": "还没有第三方提供商，可从预设添加一个。",
  ...
  "oauth.pasteCodeOrCallbackPlaceholder": "粘贴一次性授权码或完整 callback URL",
  "oauth.submitCode": "提交",
  "oauth.submitCodeFailed": "提交 code 失败",
  "oauth.pasteCodeHint": "在弹出的授权页复制显示的 code,粘到此处完成登录",
  "oauth.antigravityCodeHint": "先点授权。授权码仅用于本次登录且不会保存为 API Key；本机自动回调成功时无需填写。",
