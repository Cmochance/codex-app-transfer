...
// upstream: rust/crates/ccusage/src/adapter/codex/types.rs
use super::super::types::CodexRawUsage;

#[derive(Deserialize)]
pub struct CodexSessionLogEntry<'a> {
    #[serde(rename = "type", borrow, default)]
    pub entry_type: Option<Cow<'a, str>>,
    #[serde(borrow, default)]
    pub timestamp: Option<CodexTimestamp<'a>>,
    #[serde(
        borrow,
        default,
        deserialize_with = "deserialize_optional_object_lossy"
    )]
    pub payload: Option<CodexPayload<'a>>,
}

#[derive(Deserialize)]
pub struct CodexLogEntry<'a> {
    #[serde(borrow, default)]
    pub timestamp: Option<CodexTimestamp<'a>>,
    #[serde(rename = "created_at", borrow, default)]
    pub created_at: Option<CodexTimestamp<'a>>,
    #[serde(rename = "createdAt", borrow, default)]
    pub created_at_camel: Option<CodexTimestamp<'a>>,
    #[serde(
        borrow,
        default,
        deserialize_with = "deserialize_optional_object_lossy"
    )]
    pub data: Option<CodexResultFields<'a>>,
    #[serde(
        borrow,
        default,
        deserialize_with = "deserialize_optional_object_lossy"
    )]
    pub result: Option<CodexResultFields<'a>>,
    #[serde(
        borrow,
        default,
        deserialize_with = "deserialize_optional_object_lossy"
    )]
    pub response: Option<CodexResultFields<'a>>,
    #[serde(default, deserialize_with = "deserialize_optional_object_lossy")]
    pub usage: Option<CodexRawUsage>,
    #[serde(borrow, default)]
    ...
    pub metadata: Option<CodexModelMetadata<'a>>,
}

#[derive(Clone, Deserialize)]
#[serde(untagged)]
pub enum CodexTimestamp<'a> {
    String(Cow<'a, str>),
    Number(u64),
}
...
pub struct CodexPayload<'a> {
    #[serde(rename = "type", borrow, default)]
    pub payload_type: Option<Cow<'a, str>>,
    #[serde(
        borrow,
        default,
        deserialize_with = "deserialize_optional_object_lossy"
    )]
    pub info: Option<CodexInfo<'a>>,
    #[serde(borrow, default)]
    pub model: Option<Cow<'a, str>>,
    #[serde(rename = "model_name", borrow, default)]
    pub model_name: Option<Cow<'a, str>>,
...
#[derive(Default, Deserialize)]
pub struct CodexInfo<'a> {
    #[serde(default, deserialize_with = "deserialize_optional_object_lossy")]
    pub last_token_usage: Option<CodexRawUsage>,
    #[serde(default, deserialize_with = "deserialize_optional_object_lossy")]
    pub total_token_usage: Option<CodexRawUsage>,
    #[serde(borrow, default)]
    pub model: Option<Cow<'a, str>>,
    #[serde(rename = "model_name", borrow, default)]
    pub model_name: Option<Cow<'a, str>>,
...
#[derive(Default, Deserialize)]
pub struct CodexResultFields<'a> {
    #[serde(borrow, default)]
    pub timestamp: Option<CodexTimestamp<'a>>,
    #[serde(rename = "created_at", borrow, default)]
    pub created_at: Option<CodexTimestamp<'a>>,
...
#[derive(Deserialize)]
pub struct CodexModelMetadata<'a> {
    #[serde(borrow, default)]
    pub model: Option<Cow<'a, str>>,
}
