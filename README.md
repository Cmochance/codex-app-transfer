...
| Anthropic Messages(custom Claude-compatible) | ✅(PR #153) | ✅(PR #153) | ✅(PR #153) | `apiFormat=anthropic_messages`;新增 Anyrouter 专属 preset,强制入站模型别名走 default 并支持 Anthropic 原生 web search;通用 Claude preset 待真实验证后开放 |
