...
APP_PATH="$MAC_DIST/Codex App Transfer.app"
COLLECT_PATH="$MAC_DIST/Codex-App-Transfer"
PKG_PATH="$MAC_DIST/Codex-App-Transfer-v${VERSION}-macOS-${RELEASE_ARCH}.pkg"
DMG_PATH="$MAC_DIST/Codex-App-Transfer-v${VERSION}-macOS-${RELEASE_ARCH}.dmg"
